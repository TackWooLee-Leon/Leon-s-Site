const projectsList = [
  ...
  {
    name: 'Budget App',
    description: 'A budget app where users input their budget and expenses. It calculates and displays the remaining balance after each expense. Users can remove their expenses as well.',
